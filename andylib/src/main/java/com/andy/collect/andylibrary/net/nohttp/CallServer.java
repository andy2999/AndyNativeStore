...
public class CallServer {
     ...
     */
    public <T> void add(HttpInterface httpInterface, int what, Request<T> request, HttpListener<T> callback, boolean canCancel, boolean isLoading) {
        requestQueue.add(what, request, new HttpResponseListener<T>(httpInterface, request, callback, canCancel, isLoading));
    }
